...
import 'package:myapp/model/group_model.dart';
...
class LeftSideWidget extends StatefulWidget {
  ...
  const LeftSideWidget({required Key key, required this.sizingInformation}) : super(key: key);
...
class  ExpandedListTile extends StatelessWidget{
  ...
  const ExpandedListTile({ required this.groupModel}) ;
